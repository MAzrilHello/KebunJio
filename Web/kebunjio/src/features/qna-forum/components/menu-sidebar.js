...
function MenuSidebar(){
    ...
    return(
        <div>
            <div>
                <p style={{color: "#333"}}>Menu</p>
            </div>
            <div>
                <Link to="/forum" className="custom-link">
                    <svg style={{ marginRight: "8px" }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trophy-fill" viewBox="0 0 16 16">
            ...
            <div>
                <Link to="/forum/search" className="custom-link">
                    <svg style={{ marginRight: "8px" }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
