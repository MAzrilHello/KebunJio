...
const PostInsight = ({upvote, comment, id, hasLiked}) => {
    ...
    const handleUpvote = () => {
        if(!isAdmin){
                ...
                .then(response=>{
                    ...
                    setCurrentUpvote(response.data);
    ...
    return(
        <Container className="post-insight">
            <Row xs="auto">
                <Col onClick={handleUpvote}>
                {
                    postLiked?
                    (
                    <svg style={{color:"#666"}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
                    ...
                    <svg style={{color:"#666"}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                ...
                <span style={{marginLeft:"8px"}}>{currentUpvote}</span>
                </Col>
                <Col>
